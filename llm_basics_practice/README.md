...
4. In the left sidebar, click **Code** → **+ New Notebook**.
...
4. Give the token a name, then under permissions expand the **Inference** section and check the inference-related permissions (e.g. **Make calls to Inference Providers** and **Make calls to your Inference Endpoints**).
